...
async def create(session: AsyncSession, *, hostname: str, ip: str, mac: str, profile_id: int) -> HostORM:
...
async def update(session: AsyncSession, host_id: int, data: Mapping[str, int|str]) -> HostORM|None:
